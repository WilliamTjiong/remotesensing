...
knitr::include_graphics("drone_multisensor.png") 
...
![*Green, Red, Red Edge and NIR reflectance maps (scale is based on percentiles)*](monochrome.png){width="74%"} 

![*Band ratio and band index reflectance maps (scale is based on percentiles)*](ratio_index.png){width="70%"}


![*Turbidity maps calculated with the single band turbidity equation (scale is based on min-max of 10 sample points)*](fnu_single.png){width="70%"}
