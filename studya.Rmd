...
Applying the turbidity equation to the Red/ NIR ratio reflectance map resulted into the turbidity coverage map below. The turbidity range scales from 14 to 19 NTU.

**Interactive turbidity map**

<iframe width="100%" height="600px" src="turbidity.html" frameborder="0" allowfullscreen></iframe>
