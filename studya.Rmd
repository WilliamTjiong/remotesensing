...
addLayersControl(baseGroups = c("Topografische kaart", "Luchtfoto"),overlayGroups =c("Validation point","Turbidity (NTU)"),options = layersControlOptions(collapsed = FALSE))
